...
if __name__ == '__main__':
    ...
    for fold_id in range(n_folds):
        ...
        # loss_fn = F.nll_loss  #use for GCN_baseline or GAT model
        loss_fn = F.cross_entropy  # use for GCN_new or Multigraph models
        ...
        def train(train_loader):
            ...
            for batch_idx, data in enumerate(train_loader):
                ...
                optimizer.zero_grad()
                # output = model(data[0], data[1])  #use for GCN_baseline or GAT model
                output = model(data)  # use for GCN_new or Multigraph models
