...
def _parser():
    ...
    parser.add_argument('-D', '--dataset', type=str, default='REENTRANCY_FULLNODES_1671',
                        help='Full node dataset', choices=['REENTRANCY_CORENODES_1671', 'REENTRANCY_FULLNODES_1671',
                                                             'LOOP_CORENODES_1317', 'LOOP_FULLNODES_1317'])

# select the model of your choice

    parser.add_argument('-M', '--model', type=str, default='multigraph',
                        help='Graph Convolution Network', choices=['gat', 'GCN_baseline', 'GCN_new', 'multigraph'])

    # for Optimised multi-GCN default=0.03
    parser.add_argument('--lr', type=float, default=0.0025,
                        help='learning rate')
    parser.add_argument('--lr_decay_steps', type=str,
                        default='1,3', help='learning rate')
    parser.add_argument('--wd', type=float, default=1e-4, help='weight decay')
    # for Optimised multi-GCN default=0.3
    ...
    parser.add_argument('-F', '--folds', default=5,
                        choices=[3, 5, 10], help='n-fold cross validation')
    ...
    parser.add_argument('--bn', action='store_true',
                        default=True, help='use BatchNorm layer')
