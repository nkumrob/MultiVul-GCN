...
def _parser():
    ...
    parser.add_argument('-M', '--model', type=str, default='multigraph',
                        help = 'Graph Convolution Network', choices=['gat', 'GCN_baseline', 'multigraph'])
    ...
    parser.add_argument('--alpha', type=float, default=0.3, help='Alpha value for the leaky_relu')
